#!/home/liuhang/twatch-backend/venv/bin/python
import json
import logging
import math
...
API_URLS = ['https://letscheck.nus.edu.sg/twatchapi/api/']
...
if __name__ == '__main__':
    ...
    t.reload_trend()
    for i in range(4):
        p = multiprocessing.Process(target=process_api_requests, args=(t,))
        p.start()
