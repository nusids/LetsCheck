...
class PassageRanker(nn.Module):
    ...
    def __init__(self, model_path=None, gpu=True, device='cuda:1', label_num=2, batch_size=16):
        ...
        self.language_model = DataParallel(self.language_model, device_ids=[int(device[-1])])
